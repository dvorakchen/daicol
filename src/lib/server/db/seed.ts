...
const initApps = [
	...
	},
	{
		...
		name: '日式四宫格漫画',
		category: AppCategories.CreativeDesign,
		keywords: ['AI壁纸', '漫画分镜', 'AI漫画'],
		description: '使用人物图片生成日式四宫格漫画',
		seoKeywords: [
			'豆包AI', '四宫格漫画', '日式漫画', 'AI漫画', '漫画生成器', '创意设计', '漫画分镜', '故事创作', '漫画应用', '动漫风格', '视觉叙事'
		],
		seoDescription:
			'AI怕卤, 【豆包AI】日式四宫格漫画 & 创意设计 神器！一键将文字想法转化为日系动漫风四格漫画。快速生成漫画分镜，轻松进行故事创作和视觉叙事。你的专属AI漫画生成器，让创意无限放大！',
		model: 'seedream-4',
		source: '字节跳动',
		...
		status: AppStatus.Enabled,
		tags: ['漫画'],
		prompt: '四宫格，将原图主体转换成四宫格漫画分镜布局，日式少年漫画风格（类似 Jump 系笔触），每格呈现不同生动表情（包含惊讶张嘴、傲娇瞪眼、害羞带红晕、兴奋怒吼等神态），搭配漫画特效元素（速度线、日文拟声词 、感叹符号 “!!！” 等），四格中间交汇处有爱心边框嵌套原图主体的完整抠图形象，整体为手绘漫画质感、色彩鲜亮，AI 生成宫格漫画形式。'
	},
	{
		routeId: 10003,
		name: '品牌Logo生成',
		...
		seoKeywords: ['Logo设计', '品牌创建', 'AI设计', '矢量Logo', '创意设计', '商业标志'],
		seoDescription: '品牌Logo生成器，为你的初创企业或新项目提供无限设计灵感，快速获得专业级Logo。',
		model: 'logocraft-1',
		source: '豆包',
		icon: '/imgs/10002/icon.webp',
		barImg: '/imgs/10002/banner.webp',
	...
	},
	{
		...
		seoKeywords: ['漫画制作', '故事板', 'AI绘画', '创意设计', '动画分镜', '草图生成'],
		seoDescription: '漫画分镜助手，加速你的创作流程。将文字描述转化为可视化的漫画分镜草图。',
		model: 'comic-scene-1',
		source: '豆包',
	...
	},
	{
		...
		seoKeywords: ['插画生成', '艺术滤镜', '风格迁移', 'AI绘画', '创意设计', '照片转插画'],
		seoDescription:
	...
	},
	{
		...
		seoKeywords: ['室内设计', '装修效果图', 'AI家居', '设计灵感', '家装预览'],
		seoDescription:
	...
	},
	{
		...
		seoKeywords: ['字体设计', '书法生成', '艺术字', '创意设计', '排版工具'],
		seoDescription: '字体创作大师，为你的海报、Logo或标题设计独特的视觉焦点，让文字充满生命力。',
		model: 'font-master-1',
		source: '豆包',
		icon: 'https://img.daisyui.com/images/profile/demo/yellingcat@192.webp',
		barImg: '',
