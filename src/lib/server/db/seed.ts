...
const initApps = [
  ...
  "AI艺术肖像"
    ...
    prompt: "使用图片人物的脸，帮我生成图片:采用细腻皮肤真实质感的风格，画面中展现了一个bjd娃娃形象的妖治少少女的脸部特写，通过俯视的镜头角度进行虽现。背景为暗色，营造出暗色系且阴郁的场景氛围，少女有着散乱的湿漉漉的长发， 发丝粘在脸上，不改变原片发色。他的眼神胧，其中带着危险和眷恋的情绪，尽显腹黑高冷的气质。画面着重句勒了少女的面部细节，高先处理十分讲究，同时画面虽现出带有摄影机极蓝噪点的画质，并且有着强烈的蓝白色曝先效果。原比例。",
  },
  {
    routeId: 10007,
    name: "宫崎骏画风",
    ...
    seoKeywords: ["宫崎骏画风转换", "吉卜力风格滤镜", "AI动画风格化", "人物转宫崎骏", "背景转吉卜力", "手部细节动画化", "衣着一致性转换", "高清二次元手绘"],
    seoDescription:
