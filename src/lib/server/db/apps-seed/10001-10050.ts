...
const appSeeds = [
    ...
    },
    {
        ...
        seoKeywords: ["老照片修复专业", "顶级肖像摄影风格", "照片质量提升AI", "现代色彩分级", "专业摄影棚效果", "保留人物环境修复", "老照片高清重塑", "摄影级图像增强"],
        seoDescription: 'AI照片修复，完全保留原场景中人物、服装、姿势和环境。将您的旧照片转化为顶级肖像摄影师使用现代专业设备拍摄的，拥有充满活力色彩分级的高质量图像。',
        model: 'seedream-4',
        source: '字节跳动',
        ...
        status: AppStatus.Enabled,
        tags: ['修复', '写真', '照片', '复古'],
        prompt: '修复这张照片。目标是在完全保留原场景中人物、服装、姿势和环境的前提下，使其看起来仿佛是由顶级肖像摄影师使用现代专业设备和充满活力的色彩分级风格在今天拍摄的。不要更改场景中的任何元素，而是从根本上提升图像捕捉的质量。'
    }
];
