...
const appSeeds = [
    ...
    },
    {
        ...
        seoKeywords: ["超古风油画", "厚涂水粉技法", "丁达尔效应古风", "树枝角色仰视", "低饱和高对比油画", "人物光影层次感", "雾胧景深古风", "长发服饰发饰保留"],
        seoDescription: '极致超古风油画美学：使用厚涂水粉技法，展现颜料涂抹质感。捕捉低空仰视角度下丁达尔效应光影，营造雾胧景深。完美保留角色发型服饰细节，突出高氛围感主体。',
        model: 'seedream-4',
        source: '字节跳动',
        ...
        status: AppStatus.Enabled,
        tags: ['油画', '写真', '古风'],
        prompt: '完整保留角色发型和服饰包括发饰。参考有点油画风格，使用厚度和晕染水粉技法，展现出颜料的涂抹质感，营造超古风主义美学的高氛围感和层次感，低空仰视角度。密密匝匝的树叶和树冠，树叶缝隙中撒下阳光形成丁达尔效应，角色闲适地坐在较粗的一处树枝上，低头，脸上有光影，微微俯身看着镜头，一只手抬起扶着树干，裙摆顺着树枝垂下，裙角随风而去荡起，延伸至画面外，柔顺的长发，精致的头饰，素净的妆容，慵懒，深处，仰式视觉。皮肤苍白，绿意盎然的空间，周围光线营造出雾胧的景深氛围，突出人物主体，弱化边缘背景，近实远虚，雾感光源，颗粒感，丁达尔效应光线，高对比度，低保和。比例9:16  油画风格'
    }
];
