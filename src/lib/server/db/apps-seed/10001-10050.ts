...
const appSeeds = [
	...
	},
	{
		...
		seoKeywords: [
			"宠物国王宝座图", "超广角宠物特写", "宠物皇冠披风", "创意宠物摄影", "宫廷风宠物照", "猫狗国王", "动物肖像摄影", "可爱宠物艺术照"
		],
		seoDescription:
			'创意宠物国王大片来袭！坐拥宝座，头戴皇冠，身披王袍，超广角视角突出宠物肉垫，尽显王者风范。一张充满趣味与艺术感的宫廷风宠物特写，萌翻全场！',
		model: 'seedream-4',
		source: '字节跳动',
		originImg: '/imgs/original-cat.webp',
		...
		tags: ['宠物', '国王', '宫廷', '宫殿'],
		prompt:
			'帮我生成一张图片，图中的环境背景都去除，只保留宠物主体，保持宠物不变，以宠物脚为主题，让宠物坐在国王宝座上，双爪扶在宝座上，头戴皇冠和首饰，上身穿着一件国王披风，双腿交叉二郎腿，采用近大远小的构图和超广角视，从右往上的角度拍摄，突出脚在画面中的主体地位，增强空间感和视觉冲击力，宠物不要生成人类的脚和手，不要人的脚丫，使用宠物符合宠物脚爪的浅浅粉色的爪肉垫，比例3:4。背景是在王宫里。'
	},
	{
		routeId: 10022,
		name: '三宫格电影分镜',
		...
		seoKeywords: [
			"海边写真三宫格", "胶片质感艺术照", "傍晚沙滩摄影", "富士胶片风格", "文艺风人像", "过度曝光摄影", "冷色调写真", "自我探索情绪", "白衬衣写真", "创意字幕摄影"
		],
		seoDescription:
