...
const appSeeds = [
	...
	},
	{
		...
		seoKeywords: [
			"哈利波特宠物", "格兰芬多主题", "魔法宠物装扮", "九宫格排版", "宠物魔法造型", "霍格沃茨宠物", "创意宠物摄影", "萌宠魔法世界", "格兰芬多红色背景"
		],
		seoDescription:
		...
		status: AppStatus.Enabled,
		tags: ['哈利波特', '动物', '宠物', '魔法'],
		prompt: '帮我生成图片：这张图片以哈利波特格兰芬多学院的深红色为背景，采用九宫格排版，展示了同一只宠物的九种不同魔法主题装扮状态。第一排左边，宠物戴格兰芬多学院色小发带晃头，仿佛在念咒。第一排中间，宠物骑着扫帚飞。第一排右边，宠物穿格兰芬多学院魔法小斗篷。第二排左边，宠物的右爪子拿着魔法小魔杖，神情略显兴奋。第二排中间是半身照，宠物戴着分院帽眼睛圆溜溜，露出好奇的模样。第二排右边，宠物趴在格兰芬多魔法主题垫子上闭眼睡觉，露出放松的样子。第三排左边，宠物穿红色格兰芬多小毛衣打哈欠。第三排中间，宠物睁眼看魔法地图，呈现好奇的状态。第三排右边，宠物在魔法水晶球的右边坐好，一只爪子搭在水晶球上，保持神秘神态'
	}
];
